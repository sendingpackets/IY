...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			notify("Loading",'Please wait a moment.')
...
addcmd("savegame", {"saveplace"}, function(args, speaker)
	if saveinstance then
		notify("Loading SavePlace", "Downloading game. This will take a while")
		saveinstance()
...
addcmd('oldconsole',{},function(args, speaker)
	-- Thanks wally!!
	notify("Loading Old",'Please wait a moment.')
...
addcmd("explorer", {"dex"}, function(args, speaker)
	notify("Loading Dex++", "Please wait a moment.")
...
addcmd('olddex', {'odex'}, function(args, speaker)
	notify('Loading old explorer', 'Please wait a moment.')
...
addcmd('remotespy',{'rspy'},function(args, speaker)
	notify("Loading Cobalt",'Please wait a moment.')
